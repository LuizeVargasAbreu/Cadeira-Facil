            ...
            <div class="mdl-card mdl-cell mdl-cell--12-col">
                <div class="mdl-card__supporting-text">
                    ...
                    <table style="width: 130%">
                        ...
                        <tbody>
                            <%
                                ResultSet rs = makeQuery(String.format("SELECT DISTINCT anosemestre FROM Turma ORDER BY anosemestre DESC"));
                                ...
                                while (rs != null && rs.next()) {
                                    ...
                                    out.println(String.format("<a href=\"profOpcoes.jsp?turmaAno=%s\" class=\"a\"><button class=\"btnAcoes\"  style=\"padding: 10px 15px\">Abrir</button></a>", rs.getString("anosemestre")));
